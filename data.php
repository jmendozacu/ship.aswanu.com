...
<table width="100%" border="0" cellspacing="1" cellpadding="0" class="list_row" style="background:#e8e8e8">
    <tr>
        ...
        <a href="data.php" title="Freight Data List">Freight Data List</a>
        <a href="data.edit.php">Add Data</a>
  ...
  <?php if ($row):?>
    ...
    foreach ($frs as $rs) :?>
        <tr class="data">
            ...
            <td>
                <a href="data.edit.php?id=<?php echo $rs['id']?>&referer=<?php echo urlencode($_SERVER['REQUEST_URI']);?>" title="Edit">Edit</a>
